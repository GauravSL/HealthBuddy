...
public class AvailableHospitalFragment extends Fragment {

    private HospitalListBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = HospitalListBinding.inflate(inflater, container, false);
