...
public class BedAvailableAdapter extends RecyclerView.Adapter<BedAvailableAdapter.ViewHolder> {

    private Context context;
    private List<String> appointmentData;


    public BedAvailableAdapter(Context context, List<String> appointmentData){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            hospitalName = itemView.findViewById(R.id.txtHospital_bed_Avail);
        }
    }
}